...
namespace spades {
    ...
    class ServerListItem: spades::ui::ButtonBase {
        ...
        void Render() {
            ...
            Vector4 fgcolor = Vector4(0.7f, 0.7f, 1.f, 1.f);
            if(item.Favorite) {
                bgcolor = Vector4(0.f, 0.f, 0.f, 0.3f);
            ...
            Font.Draw(item.MapName, ScreenPosition + Vector2(400.f, 2.f), 1.f, Vector4(0.7f, 0.7f, 1.f,1));
            Font.Draw(item.GameMode, ScreenPosition + Vector2(550.f, 2.f), 1.f, Vector4(0.7f, 0.7f, 1.f,1));
            Font.Draw(item.Protocol, ScreenPosition + Vector2(630.f, 2.f), 1.f, Vector4(0.7f, 0.7f, 1.f,1));
            if(not flagIconRenderer.DrawIcon(item.Country, ScreenPosition + Vector2(700.f, size.y * 0.5f))) {
                Font.Draw(item.Country, ScreenPosition + Vector2(680.f, 2.f), 1.f, Vector4(0.7f, 0.7f, 1.f,1));
            }
        }
    }
    ...
    class ServerListHeader: spades::ui::ButtonBase {
        ...
        void Render() {
            ...
            Image@ img = renderer.RegisterImage("Gfx/White.tga");
            if(Pressed && Hover) {
                renderer.ColorNP = Vector4(0.5f, 0.5f, 1.f, 0.3f);
            } else if(Hover) {
                renderer.ColorNP = Vector4(0.5f, 0.5f, 1.f, 0.15f);
            } else {
                renderer.ColorNP = Vector4(0.5f, 0.5f, 1.f, 0.0f);
            }
